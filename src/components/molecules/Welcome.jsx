...
const Welcome = () => {
    return (
        <div className='py-32 relative w-full grid lg:items-center '>
            <Typography className="text-[#59C6A4]">I welcome you in my Development <Typography variant="h3" className="text-[#59C6A4]">Land...</Typography></Typography>
            <Typography variant="h2" className="text-[#59C6A4]">My <Typography variant="h1" className="text-[#FFB2B2]">love</Typography> coding story</Typography>
            <svg className="absolute  scale-20 -z-10" width="294" height="505" viewBox="0 0 294 505" fill="none" xmlns="http://www.w3.org/2000/svg">
