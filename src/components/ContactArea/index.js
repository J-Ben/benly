...
const ContactArea = (props) => {
  return (
    <section
      className={`wpo-contact-area section-wrap ${props.contactclass}`}
      id="contact"
    >
        ...
        <div className="container">
          <div className="row">
            ...
            <center className="pt-4">
                <img src={mail} alt="" />
              </center> <h2 className="heading-font font-bold text-5xl md:text-[35px] sm:text-[22px] mb-[15px]">
                On échange ?
              </h2>
              <p className="base-font text-lg font-normal">
                Vous pouvez me laisser un message, je vous répondrai au plus
                vite.
              </p>
              <div className="slide-btn pt-14 ">
                
                <a className="theme-btn bg-yellow-400 text-black "
                   spy={true}
                  smooth={true}
                  duration={500} href="mailto:benjaminmk9@gmail.com?subject=Message%20du%20site"> Ecrire maintenant !</a>
              </div>
