    ...
    return (
        <div className="absolute w-full top-[-280px] z-10 md:hidden">
            <div className="wraper">
                <div className="relative py-[80px] px-[165px] pl-[0] bg-[#e4e114] z-10 
            ...
            before:bg-no-repeat before:bg-center before:bg-cover before:-z-0">
                    <div className="grid grid-cols-2 gap-3 items-center relative z-20">
                        <h2 className="font-base-font font-bold text-[50px] leading-[60px] text-black xl:text-[45px] lg:text-[35px] lg:leading-[50px]">Ecrivez-moi un message, et faisons quelque chose ensemble !.</h2>
                        <div className="text-right">
                            <Link className="relative bg-[#202020] text-[#e4e114] inline-block font-semibold 
                    ...
                    before:absolute  before:content-['\f10d'] before:font-[Flaticon] before:right-[30px]
                     before:top-[50%] before:text-[14px] before:-translate-y-1/2" to="contact" spy={true} smooth={true} duration={500}>Votre message ici !</Link>
                        </div>
                    </div>
